      ...
      <section className="grid md:grid-cols-4 grid-cols-1">
        ...
        <div className="text-center my-4">
          ...
          <p className="text-sm text-zinc-400 my-4">
            Get the latest course updates and tech <br /> news delivered to your
            inbox.
          </p>
          {/* subscribe form and button */}
          <form>
            <label for="subscribe" className="hidden">
              Subscribe
            </label>
            <input
              type="email"
              required
              id="subscribe"
              className="border px-3 py-1 rounded-2xl border-zinc-800 w-1/2"
              placeholder="Enter your email"
            />
            <p className="my-3">
              <button
                type="button"
                className="bg-[#dd6713] px-10 py-1 font-semibold text-sm w-1/2 rounded-full cursor-pointer hover:opacity-75"
              >
                Subscribe
              </button>
            </p>
