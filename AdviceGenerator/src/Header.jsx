            ...
            <nav className="flex items-center justify-between">
              {/* logo */}
                <div>
                 ...
                 <div>
                    <span className="font-semibold text-2xl"><i className={`w-6 h-6 shadow-xl/30 bg-purple-100 rounded-full inset-shadow-sm bx bx-moon ${toggle && "bx bx-sun"} text-center cursor-pointer ${toggle && "text-purple-500"}`}  onClick={() => setToggle(prev => !prev)}></i></span>
                </div>
            </nav>
        </header>
    )
