    ...
    <section className="my-10">
      <div className="flex flex-col sm:flex-row items-center justify-evenly gap-4">
        ...
        <form className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          />
          <select className="px-12 py-1 border border-slate-200 rounded-md text-left sm:mx-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[repeat(2,240px)] xl:grid-cols-[repeat(4,240px)] justify-center justify-items-center md:justify-items-stretch gap-x-6 gap-y-6 my-10">
        {playersData.map((players) => (
          <div className="p-4 bg-white shadow-sm hover:shadow-md transition-shadow text-center border border-purple-100 rounded-xl w-full max-w-[240px] md:max-w-none md:w-60" key={players.id}>
            <div className="relative inline-block mb-4">
              ...
              <img src={players.photo} alt={players.name} className="w-48 h-48 object-cover rounded-2xl" />
            </div>
