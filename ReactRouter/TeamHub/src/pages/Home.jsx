  ...
  return (
    <main className="">
      ...
      <div className="flex items-center flex-col mt-56">
        <div>
          <i className="bg-purple-300/50 p-4 rounded-full mr-3 md:text-5xl text-3xl align-middle ded p bx bx-football mb-8 text-[#7f13ec]" />
        </div>

        <div className="text-center md:p-0 px-10">
          <h1 className="md:text-7xl font-extrabold mb-8 text-3xl">
            Welcome to the{" "}
            <span className="text-[#7f13ec]  font-extrabold capitalize text-wrap break-all">
              team <br />
              hub!
            </span>
          </h1>
        ...
        <div className="text-center px-10 mb-6 md:text-xl text-lg text-slate-700">
          <p>
      ...
      <div className="mb-0 mt-20 py-10 bg-white shadow-xs w-full">
        <div className="lg:px-100  px-20 pt-20">
          ...
          <p className="text-sm md:text-lg text-slate-700 md:text-auto text-center md:text-left">
        ...
        <div className="my-10 flex items-center justify-center xl:flex-row flex-col gap-5 md:p-auto p-10 ">
          ...
          <div className="bg-purple-100/50 px-8 pb-7 pt-4 rounded-2xl xl:w-90 w-full">
            ...
            <p className="text-slate-700 ">
             ...
             {/* card 2 */}
          <div className="bg-purple-100/50 px-8 pb-7 pt-4 rounded-2xl xl:w-90 w-full">
            <i className="bx bx-calendar-alt text-xl bg-purple-200/55 p-3 rounded-md mt-3"/>
            ...
            Never miss a match with our integrated calendar. Sync upcoming games fo your device.
              ...
              {/* card 3 */}
          <div className="bg-purple-100/50 px-8 pb-7 pt-4 rounded-2xl xl:w-90 w-full">
            <i className="bxf bx-announcement text-xl bg-purple-200/55 p-3 rounded-md mt-3"/>
