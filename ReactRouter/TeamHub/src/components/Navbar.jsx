...
export default function Navbar() {
  return (
    <header className="bg-[#7f13ec] text-slate-200 w-full min-w-0 flex-shrink-0">
...
{/* links */}
        <ul className="text-white capitalize lg:my-0 my-4 flex flex-wrap justify-center gap-x-6 gap-y-2 items-center">
          ...
          <button className="lg:text-lg font-semibold hover:text-slate-300 p-2 border border-zinc-500/40 rounded-xl bg-purple-300/20 capitalize px-6 hover:bg-slate-80 cursor-pointer flex-shrink-0">
