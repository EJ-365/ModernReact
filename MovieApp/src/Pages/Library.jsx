  ...
  return (
    <section>
      ...
      <div className="flex items-center justify-center flex-col w-1/2 mx-auto md:my-30 my-20">
        ...
        <div>
          <h3 className="dark:text-white text-2xl md:font-bold font-semibold text-center mt-8 mb-4">Your library is empty.</h3>
          <p className="text-zinc-400 md:text-lg  mb-4 text-center">
            Save movies and TV shows to your library to keep track of <br/> what you
            want to watch next.
          </p>
          <div className="flex items-center justify-center my-10">
            <button className="capitalize dark:bg-violet-500 bg-violet-400 text-white/90 px-7 py-3 rounded-xl font-medium  dark:text-white md:text-[17px] cursor-pointer dark:hover:bg-violet-600 duration-300 transition-colors hover:bg-violet-300">explore movies</button>
          </div>
        </div>
      </div>
    </section>
