        ...
        <div>
          ...
          <p className="text-zinc-400 md:text-lg  mb-4 text-center">
            ...
            <span className=" text-violet-300 italic font-normal">
              {" "}
              click the button above to go back home.
            </span>
          </p>
          <div className="flex items-center justify-center my-10">
            <button className="capitalize dark:bg-violet-500 bg-violet-400 text-white/90 px-7 py-3 rounded-xl font-medium  dark:text-white md:text-[17px] cursor-pointer dark:hover:bg-violet-600 duration-300 transition-colors hover:bg-violet-300">
