    ...
    return (
      <section className="dark:text-white">
        <div className="font-bold md:text-3xl flex md:justify-start md:ml-50 text-center justify-center text-xl my-10 md:my-5 ">
          <h2 className="capitalize"> TV shows</h2>
        </div>
      ...
      <div className="flex items-center justify-center my-20">
            <button className="capitalize dark:bg-violet-500 bg-violet-400 text-white/90 px-7 py-2 rounded-xl font-medium  dark:text-white md:text-[17px] cursor-pointer dark:hover:bg-violet-600 duration-300 transition-colors hover:bg-violet-300 italic">see more</button>
          </div>
      </section>
    );
  }
